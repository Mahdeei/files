                ...
                children: <Widget>[
                     ...
                     new Row(
                      ...
                      children: <Widget>[
                          ...
                          new Padding(
                            ...
                            child: new Text(widget.interShip.time_work,style: TextStyle(color: Colors.black54,fontSize: SizeConfig.textMultiplier*2))
                      )
                      ],
                      ),
                      // rowTwoKaramouziScreen(widget.interShip.numberinternship),
                    ],
                  ),
                  ...
                  Padding(
                    ...
                    child: new Row(
                      ...
                      children: <Widget>[
                        new GestureDetector(
                          child: new Text(widget.interShip.phonenumber, style: TextStyle(fontSize: SizeConfig.heightMultiplier*2.5),),
                          onTap: () {
                        ...
                        new Icon(Icons.call,size: SizeConfig.textMultiplier*3,),
                      ],
                    ),
                  )
