...
class RequestHttp {
  ...
  static Future<List> getUsernames(id) async {
    String url='http://192.168.1.5/Stub/getUsernameReq.php';
  ...
  static Future<Map> getAd(id) async {
    String url='http://192.168.1.5/Stub/getRequestsAd.php';
  ...
  static Future<Map> getIntern(id) async {
    String url='http://192.168.1.5/Stub/getRequestIntern.php';
