...
class RequestHttp {
  ...
  static Future<List> getUsernames(id) async {
    String url='http://192.168.1.4/Stub/getUsernameReq.php';
  ...
  static Future<Map> getAd(id) async {
    String url='http://192.168.1.4/Stub/getRequestsAd.php';
  ...
  static Future<Map> getIntern(id) async {
    String url='http://192.168.1.4/Stub/getRequestIntern.php';
